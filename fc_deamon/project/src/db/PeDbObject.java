...
public class PeDbObject implements Serializable
{
     ...
     * 生成插入一个条目 sql 语句的方法
     */
    private String generateInsertObjectSql(String key) throws IllegalArgumentException, IllegalAccessException
    {
        StringBuilder sb = new StringBuilder();
     ...
     * 更新对象的方法
     */
    void updateObject(XWHResultSetMapper mapper, String filter, String condition) throws Exception
    {
        String splitName = getTableSplitName();
