...
public class XwhTool
{
    ...
    {
        return parseConfigString(content, c, "yyyy-MM-dd");
    }

    /**
     * 解析配置字符串的方法
     */
    public static <T> T parseJSONString(String content, Type typeOfT)
    {
        if (null == content)
        {
            return null;
    ...
    {
        Map<Integer, Integer> map = parseJSONByFastJSON(json, new TypeToken<Map<Integer, Integer>>()
        {
        }.getType());
        if (map == null)
            map = new HashMap<>();
    ...
    public static Map<String, String> parseJsonBase(String json)
    {
        if (json == null)
            return new HashMap<>();
        Map<String, String> map = parseJSONByFastJSON(json, new TypeToken<Map<String, String>>()
        {
        }.getType());
        if (map == null)
            map = new HashMap<>();
     ...
     * 获取class 对应key,value
     *
     * @param outClass class 对象
     * @param t        实体
     * @param <T>      对象
     * @return hash
     */
    public static <T> HashMap<String, Object> getClassInfo(Class<T> outClass, T t)
    {
