...
public class GameDayInfo {
    ...
    private Integer ddpriority;//优先级
    private String ddcode;
    private boolean ddgroup;
    private String ddname;//比赛名称信息
    ...
    public void setDdaward8512a(String ddaward8512a) {
        this.ddaward8512a = ddaward8512a;
    }
    ...
    public void setDdaward9512a(String ddaward9512a) {
        this.ddaward9512a = ddaward9512a;
    }
    ...
    public String toString() {
        return "GameDayInfo{" +
                ...
                ", ddhour0=" + ddhour0 +
                ", ddaward0512a='" + ddaward0512a + '\'' +
                ", ddhour1=" + ddhour1 +
                ", ddaward1512a='" + ddaward1512a + '\'' +
                ", ddhour2=" + ddhour2 +
                ", ddaward2512a='" + ddaward2512a + '\'' +
                ", ddhour3=" + ddhour3 +
                ", ddaward3512a='" + ddaward3512a + '\'' +
                ", ddhour4=" + ddhour4 +
                ", ddaward4512a='" + ddaward4512a + '\'' +
                ", ddhour5=" + ddhour5 +
                ", ddaward5512a='" + ddaward5512a + '\'' +
                ", ddhour6=" + ddhour6 +
                ", ddaward6512a='" + ddaward6512a + '\'' +
                ", ddhour7=" + ddhour7 +
                ", ddaward7512a='" + ddaward7512a + '\'' +
                ", gameDateSurvey='" + gameDateSurvey + '\'' +
                '}';
    }
